...
<table id="reprocesos" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
    <thead>
        <tr>
            <th class="bg-purple text-white">Entrada</th>
            <th class="bg-purple text-white">Referencia</th>
            <th class="bg-purple text-white">Reprocesos</th>
            <th class="bg-purple text-white">Nombre Operario</th>
...
<script>
    ...
    $('.formulario-eliminar').submit(function(e){
        ...
        Swal.fire({
            title: "¿Esta seguro?",
            text: "Este reproceso se reincorporara a la mercancia ",
            icon: "warning",
